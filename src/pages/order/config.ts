...
// 套餐详情
export interface PACKAGE_DETAIL_OBJ {
...
export interface PACKAGE_CONTENT {
  readonly key: string, name: string, host: string, price: number, marking?: string,picUrl: string
...
export interface MyOrderPackage {
  ...
  deliveryDate?: string;
  state: MyOrderStateType;
  serviceList?: Array<ServiceList>;
  price: number;
}

export const myOrderList: Array<MyOrderPackage> = [
  {
    name: '本孕期胎监套餐',
    ...
    deliveryDate: '',
    state: MyOrderStateType.TO_BE_PAID,
    price: 5000,
    serviceList: [
      {
        name: '胎监判图服务',
        ...
        remark: '',
        stateRecord: [
          {name: '胎监判断服务', state: '已使用', date: '2019-12-11 11:03'},
          {name: '胎监判断服务', state: '已使用', date: '2019-12-16 11:03'},
          {name: '胎监判断服务', state: '已使用', date: '2019-12-19 11:03'},
        ]
      },
      {
        name: '民用版',
  ...
  },
  {
    ...
    effectiveDate: '2019-12-12',
    deliveryDate: '',
    state: MyOrderStateType.TO_BE_PICK,
    price: 5000,
    serviceList: [
      {
        name: '胎监判图服务',
